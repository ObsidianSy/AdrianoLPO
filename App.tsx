...
const PILLARS = [
  {
    title: "Consciência",
    text: "Conduzir o indivíduo à lucidez sobre si, suas escolhas e seus limites.",
  },
  {
    title: "Visão",
    text: "Treinar o olhar, ampliar a percepção e revelar o que não é visto.",
  },
  {
    title: "Direção",
    text: "Ajustar a rota com propósito, responsabilidade e clareza.",
  },
  {
    title: "Identidade",
    text: "Reconectar a pessoa à sua verdade e coerência interna.",
  },
  {
    title: "Expansão",
    text: "Transformar pequenos ajustes em crescimento sustentável.",
  },
];
...
const VALUES = [
  {
    title: "Verdade",
    text: "A transformação começa quando você para de se esconder de si mesmo.",
  },
  {
    title: "Responsabilidade",
    text: "Crescimento não é sorte, é consequência das escolhas.",
  },
  {
    title: "Clareza",
    text: "Direção nasce de percepção limpa, não de impulsos.",
  },
  {
    title: "Propósito",
    text: "Cada decisão deve sustentar quem você escolheu ser.",
  },
  {
    title: "Coerência",
    text: "A vida responde ao que você faz, não ao que você apenas deseja.",
  },
  {
    title: "Consciência",
    text: "Nenhuma expansão é real quando não existe presença.",
  },
];
  ...
  return (
    <nav
      className={`relative z-50 transition-all duration-500 ${
        scrolled
          ? "bg-luxury-950/95 backdrop-blur-md py-3 border-b border-luxury-800 shadow-2xl"
          : "bg-transparent py-5"
      }`}
    >
      <div className="w-full px-6 flex justify-between items-center">
        ...
        >
          <span className="font-sans text-xs tracking-[0.1em] text-gold-200 font-normal group-hover:text-gold-400 transition-colors">
            Adriano
          </span>
          <span className="text-[8px] uppercase tracking-[0.2em] text-gray-500 group-hover:text-gold-300 transition-colors font-light">
            Rodrigo
          </span>
        </a>
        ...
        {/* Mobile Toggle */}
        <button
          className="md:hidden text-gold-200 p-2 rounded-full hover:bg-white/5 transition-colors"
        ...
        <div className="relative z-50 h-full bg-luxury-950 overflow-auto p-6 flex flex-col">
          <div className="relative mb-4 border-b border-luxury-800/20 pb-4">
            <div className="flex items-center justify-center">
              <div className="flex items-center gap-2">
                <div className="text-gold-200 font-serif text-sm tracking-[0.15em]">
                  ADRIANO
                </div>
          ...
          <nav className="mt-4 space-y-3 flex-1 flex flex-col items-center justify-center">
            {NAV_LINKS.map((link) => (
              ...
              >
                ...
                <span className="text-center text-sm font-light uppercase tracking-[0.12em] text-white">
                  {link.name}
                </span>
              </button>
            ))}
          ...
          <div className="mt-4">
            <a
              ...
              onClick={() => setIsOpen(false)}
              className="w-full inline-flex justify-center items-center gap-2 bg-gold-600 text-black font-semibold uppercase tracking-[0.15em] px-4 py-2.5 rounded-full text-xs"
            >
              Agendar Conversa
            </a>
          </div>
...
const MethodSection = () => {
  return (
    <section
      id="metodo"
      className="py-12 bg-luxury-950 relative overflow-hidden rounded-[3rem] my-8 mx-2 md:mx-6 shadow-2xl border-t border-luxury-800"
    >
      {/* Decorative */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row gap-16 items-center">
          ...
          <div className="md:w-1/2 space-y-8">
            <div>
              <span className="text-gold-600 text-[10px] font-normal tracking-[0.15em] uppercase">
                O Método
              </span>
              <h2 className="font-sans text-2xl md:text-3xl text-white mt-2 mb-6 font-light tracking-tight">
                Rota 360°
              </h2>
              <p className="text-sm text-gray-400 font-light leading-relaxed">
                O Rota 360 é um processo de leitura completa da vida em 360°:
                mental, emocional, espiritual e prático.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-6">
              <div className="flex gap-6 items-start bg-luxury-900 p-6 rounded-2xl border border-luxury-600/10">
                <div className="mt-1 text-gold-600 bg-gold-900/10 p-3 rounded-full">
                  <Target size={20} />
                </div>
                <div>
                  <h4 className="text-white font-sans text-sm mb-2 font-medium">
                    O que ele revela?
                  </h4>
                  <ul className="space-y-2 text-xs text-gray-500">
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 bg-gold-600 rounded-full" />{" "}
                      Pontos cegos e desalinhamentos
                    </li>
                    <li className="flex items-center gap-2">
                      <span className="w-1 h-1 bg-gold-600 rounded-full" />{" "}
                      Verdades ignoradas
              ...
              <div className="flex gap-6 items-start bg-luxury-900 p-6 rounded-2xl border border-luxury-600/10">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Espiritualidade prática, consciência elevada, visão
                    estratégica, leitura comportamental e clareza de propósito.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="pt-2">
              <p className="text-sm text-white font-light border-l-2 border-gold-700 pl-6 py-2 leading-relaxed">
                ...
                <span className="text-gold-500 font-normal">
                  alinhar rota e restaurar direção.
                </span>
              </p>
            </div>
          </div>
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-luxury-950 to-luxury-900 p-8 md:p-10 rounded-2xl border border-gold-900/30 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            <span className="text-gold-600 text-[10px] font-normal tracking-[0.2em] uppercase block mb-3">
              Material Gratuito
            </span>
            <h2 className="font-sans text-xl md:text-2xl text-white mb-4 font-light">
              Baixe o Guia:{" "}
              <span className="text-gold-400">
                5 Passos para Clareza de Propósito
              </span>
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto mb-6 leading-relaxed text-xs">
              Descubra como líderes de alta performance alinham visão, direção e
              propósito em apenas 5 passos práticos.
            </p>
...
const Footer = ({ onOpenAdmin }) => {
  return (
    <footer
      id="contato"
      className="bg-black py-12 rounded-t-[2rem] border-t border-luxury-800 mt-8"
    >
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
          <div className="text-center md:text-left max-w-sm">
            <h2 className="font-sans text-lg text-white mb-2 font-light tracking-tight">
              Adriano Rodrigo
            </h2>
            <p className="text-[10px] text-gold-600 tracking-[0.2em] mb-5 font-light">
              Mentor de Posicionamento
            </p>
            ...
            <div className="flex justify-center md:justify-start space-x-6">
              <a
                href="https://www.instagram.com/adrianorodrigo.oficial?igsh=aXpteXVmZHV0Zzdz"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-gold-400 transition-colors bg-white/5 p-3 rounded-full hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-gold-500"
                aria-label="Instagram de Adriano Rodrigo"
              >
                <Instagram size={18} />
              </a>
              <a
                ...
                rel="noopener noreferrer"
                className="text-gray-600 hover:text-gold-400 transition-colors bg-white/5 p-3 rounded-full hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-gold-500"
                aria-label="LinkedIn de Adriano Rodrigo"
              >
                <Linkedin size={18} />
              </a>
              <a
                href="mailto:contato@adrianorodrigo.com"
                className="text-gray-600 hover:text-gold-400 transition-colors bg-white/5 p-3 rounded-full hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-gold-500"
          ...
          <div className="text-center md:text-right max-w-md">
            <h3 className="font-sans text-base text-white mb-4 font-light">
              Vamos Conversar?
            </h3>
            <p className="text-gray-500 font-light text-[11px] mb-5 leading-relaxed">
              Se você busca direção e não apenas velocidade, está no lugar
              certo. Agende uma sessão de Rota 360 ou Mentoria.
            </p>
            <a
              href={WA_LINK("5516999963461")}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-10 py-4 bg-gold-700 text-white text-[10px] font-normal tracking-wide hover:bg-gold-600 transition-colors shadow-lg shadow-black/50 rounded-full"
            >
              Agendar Conversa
            </a>
          </div>
        ...
        <div className="mt-20 pt-8 border-t border-luxury-900 flex flex-col md:flex-row justify-between items-center text-[10px] text-gray-700 gap-4 font-light">
          <p>
            &copy; {new Date().getFullYear()} Adriano Rodrigo. Todos os direitos
            reservados.
          </p>
          <div className="flex items-center gap-4">
            ...
            >
              <Lock size={11} />
              <span className="font-normal tracking-wide text-[9px]">
                Área do Mentor
              </span>
            </button>
          </div>
...
const AdminModal = ({
  ...
  const totalBytes = Array.isArray(events)
    ? events.reduce((sum, ev) => sum + estimateDocSize(ev), 0)
    : 0;
  const totalMB = (totalBytes / (1024 * 1024)).toFixed(2);
  const maxMB = 1024;
  const percent = Math.min(
    100,
    (totalBytes / (1024 * 1024) / maxMB) * 100
  ).toFixed(2);
    ...
    >
      ...
      {toast && (
        <div
          ...
          } text-white px-6 py-4 rounded-xl shadow-2xl flex items-center gap-3 animate-fade-in`}
        >
            ...
            <form onSubmit={handleSubmit} className="p-8 space-y-8">
              ...
              <div className="space-y-4">
                <h3 className="text-gold-400 font-serif text-base uppercase tracking-widest border-b border-gold-900/30 pb-3 flex items-center gap-2">
                  <span className="bg-gold-500/10 text-gold-500 w-7 h-7 rounded-full flex items-center justify-center text-sm font-bold">
                    1
                  </span>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full bg-luxury-950 border ${
                        errors["title"]
                          ? "border-red-500"
                          : "border-luxury-600/30"
                      } rounded-xl p-4 text-white focus:border-gold-500 outline-none transition-all placeholder-gray-600`}
                    />
                    {errors["title"] && (
                    ...
                    <textarea
                      ...
                      className={`w-full bg-luxury-950 border ${
                        errors["description"]
                          ? "border-red-500"
                          : "border-luxury-600/30"
                      } rounded-xl p-4 text-white focus:border-gold-500 outline-none transition-all resize-none placeholder-gray-600`}
                    />
                    {errors["description"] && (
                      <p className="text-red-400 text-xs mt-1">
                        {errors["description"]}
                      ...
                      {formData.image ? (
                        <div className="relative w-full h-48 rounded-xl overflow-hidden group-hover:opacity-70 transition-opacity">
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/50">
                            <p className="text-white font-bold px-4 py-2 rounded-lg bg-gold-600">
                              Trocar Imagem
                            </p>
                          </div>
                        </div>
            ...
            <div className="p-6">
              <div className="mb-4">
                ...
                <p className="text-gray-500 text-xs">
                  Gerencie todos os eventos da agenda
                </p>
              </div>
              ...
              {events && events.length > 0 ? (
                <div className="space-y-3">
                  {events.map((event) => (
                    <div
                      key={event.id}
                      className="bg-luxury-950 border border-luxury-600/30 rounded-xl p-4 hover:border-gold-500/40 transition-all group"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div className="bg-luxury-950 border border-luxury-600/30 rounded-xl p-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h4 className="text-gray-400 text-xs uppercase font-bold">
                      Total de Eventos
                    </h4>
                  </div>
                ...
                <div className="bg-luxury-950 border border-luxury-600/30 rounded-xl p-4">
                  ...
                  <p className="text-white text-3xl font-bold">
                    {new Set(events?.map((e) => e.status) || []).size}
                  </p>
                </div>
              </div>
        ...
        <div className="p-8 overflow-y-auto custom-scrollbar">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 leading-relaxed text-sm">
              {event.description} Uma experiência imersiva desenhada para
              destravar seu potencial de liderança e alinhar seu propósito de
              vida com suas ações diárias.
            </p>
          </div>
              ...
              <div className="space-y-4">
                {event.schedule.map((item, idx) => (
                  ...
                  >
                    ...
                    <div>
                      <p className="text-gold-600 text-xs font-bold">
                        {item.time}
                      </p>
    ...
    <div className="min-h-screen bg-luxury-950 animate-fade-in flex flex-col">
      ...
      <header className="relative h-[60vh] min-h-[500px] flex flex-col">
        ...
        <div className="relative z-10 flex-grow flex flex-col justify-center items-center text-center px-4">
          <span className="text-gold-200 font-bold tracking-[0.25em] text-[10px] uppercase mb-4 animate-fade-in drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
            Programação Oficial
          </span>
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {currentEvents.map((event) => (
                <div
                  key={event.id}
                  className="bg-luxury-900 rounded-2xl overflow-hidden border border-luxury-600/20 hover:border-gold-500/40 shadow-xl hover:shadow-2xl transition-all duration-500 group flex flex-col"
                >
                  {/* Card Header Image */}
    ...
    >
      ...
      <div className="relative bg-luxury-900 w-full max-w-3xl rounded-3xl border border-gold-900/30 shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
        ...
        <div className="relative h-48 md:h-64 overflow-hidden">
          ...
          <div className="absolute top-20 md:top-28 left-0 px-6 md:px-8 w-full">
            <div className="flex items-end gap-4">
              <div>
                <h2
                  id="about-modal-title"
                  className="font-sans text-2xl md:text-3xl text-white mb-2 leading-tight drop-shadow-lg font-light tracking-tight"
                >
                  Adriano Rodrigo
                </h2>
                <p className="text-gold-400 font-light tracking-wide text-[10px]">
                  Mentor de Posicionamento
                </p>
              </div>
            </div>
          ...
          <div className="prose prose-invert max-w-none">
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-white font-sans text-base m-0 font-medium">
                  Minha Jornada
                </h3>
              </div>
              <div className="text-gray-400 leading-relaxed text-xs md:text-sm font-light space-y-3">
                <p>
                  Sou pai da Laura e da Antonella e essa é minha maior fonte de
                  responsabilidade, propósito e direção.
                </p>
                <p>
                  A paternidade me ensinou que não basta sonhar: é preciso
                  construir com consciência e decidir todos os dias quem
                  escolhemos ser, não apenas para nós, mas para quem nos
                  observa.
                </p>
                <p>
                  Morei no Japão por seis anos consecutivos e, longe da zona de
                  conforto, aprendi o valor da disciplina silenciosa, do
                  respeito profundo e da constância invisível.
                </p>
                <p>O Japão não me ensinou teoria me ensinou modo de vida.</p>
                <p>
                  Cada lugar por onde passei me lapidou: não carrego apenas
                  histórias, carrego marcas.
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="text-gray-400 leading-relaxed text-xs md:text-sm font-light space-y-3">
                <p>
                  Sou movido por um princípio simples e raro: clareza gera
                  força.
                </p>
                <p>Posicionamento não é aparência. É coerência.</p>
                <p>Autoridade não é volume. É constância.</p>
                <p>Sucesso não é pressa. É direção.</p>
                <p>
                  Não ensino motivação vazia: entrego consciência aplicável,
                  norte e retorno ao essencial.
                </p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3 p-4 bg-luxury-950 rounded-xl border border-luxury-600/10">
                  <div className="w-1.5 h-1.5 bg-gold-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <p className="text-gray-400 text-xs font-light">
                    Auditor na Segurança do Trabalho
                  </p>
                </div>
                <div className="flex items-start gap-3 p-4 bg-luxury-950 rounded-xl border border-luxury-600/10">
                  <div className="w-1.5 h-1.5 bg-gold-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <p className="text-gray-400 text-xs font-light">
                    Gestão produção industrial
                  </p>
                </div>
                <div className="flex items-start gap-3 p-4 bg-luxury-950 rounded-xl border border-luxury-600/10">
                  <div className="w-1.5 h-1.5 bg-gold-500 rounded-full mt-1.5 flex-shrink-0"></div>
                ...
                <div className="flex items-start gap-3 p-4 bg-luxury-950 rounded-xl border border-luxury-600/10">
                  <div className="w-1.5 h-1.5 bg-gold-500 rounded-full mt-1.5 flex-shrink-0"></div>
                  <p className="text-gray-400 text-xs font-light">
                    Treinamento em inteligência emocional, gestão das emoções e
                    neurociência
                  </p>
                </div>
              </div>
            ...
            <div className="mb-8">
              ...
              <div className="text-gray-400 leading-relaxed text-xs md:text-sm font-light space-y-3">
                <p>Não falo do que li — falo do que vivi.</p>
                <p>
                  Tudo o que comunico nasce da experiência, não da suposição.
                </p>
                <p>Não prometo atalhos. Ofereço norte.</p>
                <p>
                  Não empurro pessoas para longe de si. Conduzo de volta para
                  dentro.
                </p>
                <p>
                  Hoje, minha missão é alinhar pessoas, marcas e decisões ao
                  eixo essencial: quem você é de verdade e para onde está indo.
                </p>
                <p className="text-gold-400 font-medium">
                  Meu trabalho não é mudar você. É revelar você.
                </p>
              </div>
            </div>
        ...
        <div className="flex items-start gap-4 flex-grow">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              ...
              personalizar conteúdo. Ao continuar navegando, você concorda com
...
const App = () => {
  ...
  const handleAddEvent = async (newEvent) => {
    ...
    if (result.success) {
      ...
      setToast({
        type: "error",
        message: result.error || "Erro ao criar evento",
      });
    }
  };
  ...
  const handleUpdateEvent = async (eventId, eventData) => {
    ...
    if (result.success) {
      ...
      setToast({
        type: "error",
        message: result.error || "Erro ao atualizar evento",
      });
    }
  };
    ...
    <main className="font-sans text-gray-200 selection:bg-gold-600 selection:text-white min-h-screen relative">
      ...
      <div className="md:hidden bg-luxury-950 min-h-screen">
        ...
        {currentView === "home" ? (
          ...
          <AgendaPage onBack={() => handleNavigate("home")} events={events} />
        ) : currentView === "pdf" ? (
          <PdfViewerPage
            pdfId={currentPdfId}
            onBack={() => handleNavigate("home")}
